...
class _CustomTabBarState extends ConsumerState<CustomTabBar> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return TabBar(
      ...
      isScrollable: true,
      labelStyle: TextStyleManager.medium(fontSize: 14, color: AppColors.white),
      labelColor: widget.labelColor,
      unselectedLabelStyle: TextStyleManager.medium(fontSize: 14, color: AppColors.whiteOpacity5),
